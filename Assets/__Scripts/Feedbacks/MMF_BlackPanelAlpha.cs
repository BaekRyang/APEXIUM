...
{
    [AddComponentMenu("")]
    [FeedbackPath("_CustomFeedbacks/BlackboardAlpha")]
    public class MMF_BlackPanelAlpha : MMF_Feedback
    {
        [MMFInspectorGroup("Tween", true, 79)]
        [Inject("BlackBoard")] [SerializeField]
        ...
        private async UniTask Animate()
        {
            ...
            while (_elapsedTime < _duration)
            {
                ...
                _image.color = new Color(_image.color.r, _image.color.g, _image.color.b, Mathf.Lerp(_from, _to, _current));
