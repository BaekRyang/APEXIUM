...
namespace MoreMountains.Feedbacks
{
	...
	public class MMFeedbacks : MonoBehaviour
	{
		...
		public async UniTask PlayFeedbacksUniTask(Vector3 _position, float _feedbacksIntensity = 1.0f, bool _forceRevert = false)
		{
			PlayFeedbacks(_position, _feedbacksIntensity, _forceRevert);
			while (IsPlaying) 
				await UniTask.Yield();
		}
